...
function VehicleDetails({
  ...
  console.log({
    aaaaaa: dimensionData?.filter?.((item) => item?.value == 1),
    bbbbbbb: dimensionData,
  });
            ...
            <div className="row card-body">
              ...
              <div className="col-lg-4">
                <CustomDropdown
                  ...
                  //   values={dimensionData?.filter?.(
                  //     (item) => item?.value == getFieldProps("dimension").value
                  //   )}
                  {...getFieldProps("dimension")}
                  onChange={(value) => {
                    setFieldValue("dimension", value?.[0]?.value, true);
                  }}
              ...
              <div className="col-lg-4">
                <CustomDropdown
                  ...
                  onChange={(value) => {
                    setFieldValue("vehicleCategory", value?.[0]?.value);
                  }}
              ...
              <div className="col-lg-4">
                ...
                <CustomFileUpload
                  accept=".pdf, .doc, .docx"
                  onChange={(event) => {
                    setFieldValue("pucDocument", event?.target?.files?.[0]);
                  }}
                  // onChange={(event) => handleFileChange(event)}
                  // errors={formik.errors.insuranceAmount}
                  // message={formik.errors.insuranceAmount}
