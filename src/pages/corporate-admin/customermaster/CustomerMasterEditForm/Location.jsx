...
const Location = ({ locationList, locationData }) => {
   ...
   const [initialState, setInitialState] = useState({
      ...
      location: "",
      locationMasterId: "",
      locationValues: [{ label: "", value: "" }],
   });

   console.log({ location: initialState?.locationValues });
            ...
            <button
               ...
               onClick={() => {
                  ...
                  setInitialState({
                     ...
                     locationValues: locationData?.filter?.(
                        (loc) => loc?.value === item?.pivot?.location_master_id
                     ),
                  });
                  handleShowModal();
               }}
   ...
   const handleLocationAdd = () => {
      ...
      newData.append("customer_master_id", params?.id);
      newData.append("location_master_id[]", JSON.stringify([initialState?.location]));
      // newData.append(
      //     "location_id[]",
               ...
               <>
                  <div className="col-lg-12" style={{ minHeight: 300 }}>
                     <CustomDropdown
                        ...
                        label="Location"
                        id=""
                        values={initialState.locationValues}
                        onChange={(values) => {
